...
type Game struct {
	...
	Win                  int     `json:"win" gorm:"default:0"`                                   // 0 无 1 黑 2 白 3 和 4 双方弃权
...
func SelectOneGame(tx *gorm.DB, query *Game, otherQuery ...func(db *gorm.DB) *gorm.DB) (*Game, error) {
...
// swagger:ignore @param 	 otherQuery   []func "其他查询条件"
// swagger:ignore @return    data        []Game        "查询的结果"
func SelectGames(tx *gorm.DB, query *Game, otherQuery ...func(db *gorm.DB) *gorm.DB) ([]Game, error) {
	if query == nil && otherQuery == nil {
		return nil, errors.New("查询参数错误")
	}
	if tx == nil {
...
// swagger:ignore @param     query        *Game         "查询结构体 不可为nil"
// swagger:ignore @param 	 otherQuery   func "其他查询条件"
func ScanGames(tx *gorm.DB, query *Game, otherQuery func(db *gorm.DB) *gorm.DB) error {
	if query == nil && otherQuery == nil {
...
func CreateGames(tx *gorm.DB, create ...*Game) error {
	if create == nil {
		return errors.New("创建参数错误")
	}
	if tx == nil {
		return errors.New("事务参数错误")
	}
	tx = tx.Model(&Game{})
...
// swagger:ignore @param 	 otherQuery   []func "其他查询条件"
func UpdateGames(tx *gorm.DB, query *Game, update *Game, otherQuery ...func(db *gorm.DB) *gorm.DB) error {
	if query == nil && otherQuery == nil {
